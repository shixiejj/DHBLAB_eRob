...
struct Pdo_value
{
	...
	Pdo_value(const Pdo_value &value_in)
	{
		char_value = value_in.char_value;
		short_value = value_in.short_value;
		int_value = value_in.int_value;
		uchar_value = value_in.uchar_value;
		ushort_value = value_in.ushort_value;
		uint_value = value_in.uint_value;
	}
	Pdo_value operator=(const Pdo_value &value_in)
	{
		char_value = value_in.char_value;
		short_value = value_in.short_value;
		int_value = value_in.int_value;
